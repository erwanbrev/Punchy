        ...
        <div>
            ...
            <nav className="leftMenu">
                ...
                <div className="cont-Nav">
                    <NavLink activeclassname="active" to="/event" className="nameNav" > <IoBeer className="iconMenu" color="#FFF" size='30' /> <span id="event">Événement</span> </NavLink>
                    <NavLink activeclassname="active" to="/carpool" className="nameNav"> <IoCarSharp className="iconMenu" color="#FFF" size='30' /> Covoiturage</NavLink>
                    <NavLink activeclassname="active" to="/housing" className="nameNav"> <IoBusiness className="iconMenu" color="#FFF" size='30' /> Logement</NavLink>
                    <NavLink activeclassname="active" to="/friends" className="nameNav"> <IoPersonAdd className="iconMenu" color="#FFF" size='30' /> Amis</NavLink>
                </div>
                <div className="min-compte">
                    <NavLink to="/login" className="nameNav">
                        <IoPersonCircle className="iconMenu" color="#FFF" size='30' /> <span className="event">Connexion</span>
                    </NavLink>
                    <NavLink to="/register" className="nameNav">
                        <IoPersonCircle className="iconMenu" color="#FFF" size='30' /> <span className="event">Inscription</span>
                    </NavLink>
                </div>
            </nav >
