    ...
    return (
        <div>
            ...
            <nav className="mobile-head">
                <div id="logo-mobile">
                    <img src={require('../../public/assets/img/svg/logo.svg')} alt="logo-mobile" />
                </div>
            </nav>
            {/* Menu latérale gauche version Desktop */}
            <nav className="leftMenu">
                <div id="logo">
                    <img src={require('../../public/assets/img/svg/logo.svg')} alt="logo" />
                </div>
                <div className="cont-Nav">
                    ...
                    <Link to="/amis" className="nameNav"><img src={require('../../public/assets/img/svg/nb_personnes.svg')} alt="logo-geoloc" />Amis</Link>
                </div>
                <div className="min-compte">
                    <Link to="/compte" className="nameNav">
                        <img src={require('../../public/assets/img/svg/nb_personnes.svg')} alt="min-compte" />Connexion
                    </Link>
                </div>
            </nav>
            {/* Version Mobile */}
